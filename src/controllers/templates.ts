...
export const create_template = async (
  ...
  try {
    const { label, description, fields, group_ids } = validate(
      createTemplateSchema,
      req.body
    );
...
export const read_templates = async (
  req: Request,
  res: Response,
  next: NextFunction
): Promise<void> => {
...
export const read_template = async (
  req: Request,
  res: Response,
  next: NextFunction
): Promise<void> => {
  ...
  try {
    const { template_id } = validate(templateIdParamsSchema, req.params);
    const user_id = get_current_user_id(res);
...
export const update_template = async (
  ...
  try {
    const { template_id } = validate(templateIdParamsSchema, req.params);
    const { label, description, group_ids, fields } = validate(
      updateTemplateSchema,
      req.body
    );
...
export const add_template_manager = async (
  req: Request,
  res: Response,
  next: NextFunction
): Promise<void> => {
  ...
  try {
    const { template_id } = validate(templateIdParamsSchema, req.params);
    const { user_id } = validate(addTemplateManagerSchema, req.body);
