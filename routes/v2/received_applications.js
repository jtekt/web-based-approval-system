...
router.route('/pending/count').get(controller.get_submitted_pending_applications_count)
router.route('/rejected/count').get(controller.get_submitted_rejected_applications_count)
router.route('/approved/count').get(controller.get_submitted_approved_applications_count)
